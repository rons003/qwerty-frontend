...
@Component({
  moduleId: module.id,
  selector: 'cg-course-detail',
  templateUrl: 'course-detail.component.html',
  styleUrls: ['./course.component.css', './course-detail.component.css'],
})
export class CourseDetailComponent implements OnInit {
  ...
  blurBackground() {
    $('.page-full').css('filter', 'blur(5px)');
    $('#fullHeightModalLeft').css('background-color', 'rgba(255, 255, 255, 0.5)');
  }

  closeModal() {
      $('#fullHeightModalLeft').modal('hide');
      $('.page-full').css('filter', 'blur(0px)');
  }
